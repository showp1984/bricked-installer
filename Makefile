...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Mon Jul 9 13:43:56 2012
...
CC            = gcc
CXX           = g++
DEFINES       = -DAPP_VERSION=\"0.2\" -DQT_NO_DEBUG -DQT_SQL_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/Bricked-Installer0.2 || $(MKDIR) .tmp/Bricked-Installer0.2 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Bricked-Installer0.2/ && $(COPY_FILE) --parents mainwindow.h dragons.h info.h detect.h flasher.h openfile.h update_notif.h quazip/crypt.h quazip/ioapi.h quazip/JlCompress.h quazip/quaadler32.h quazip/quachecksum32.h quazip/quacrc32.h quazip/quazipfile.h quazip/quazipfileinfo.h quazip/quazip_global.h quazip/quazip.h quazip/quazipnewinfo.h quazip/unzip.h quazip/zip.h .tmp/Bricked-Installer0.2/ && $(COPY_FILE) --parents res/res_loc.qrc .tmp/Bricked-Installer0.2/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp dragons.cpp info.cpp detect.cpp flasher.cpp openfile.cpp update_notif.cpp database.cpp quazip/unzip.c quazip/zip.c quazip/JlCompress.cpp quazip/qioapi.cpp quazip/quaadler32.cpp quazip/quacrc32.cpp quazip/quazip.cpp quazip/quazipfile.cpp quazip/quazipnewinfo.cpp .tmp/Bricked-Installer0.2/ && $(COPY_FILE) --parents mainwindow.ui dragons.ui info.ui detect.ui flasher.ui openfile.ui update_notif.ui .tmp/Bricked-Installer0.2/ && (cd `dirname .tmp/Bricked-Installer0.2` && $(TAR) Bricked-Installer0.2.tar Bricked-Installer0.2 && $(COMPRESS) Bricked-Installer0.2.tar) && $(MOVE) `dirname .tmp/Bricked-Installer0.2`/Bricked-Installer0.2.tar.gz . && $(DEL_FILE) -r .tmp/Bricked-Installer0.2
...
update_notif.o: update_notif.cpp quazip/quazip.h \
		quazip/zip.h \
		quazip/ioapi.h \
		quazip/unzip.h \
		quazip/quazip_global.h \
